...
st.divider()
st.info("핵심: dataset_index를 만든 직후 바로 OpenAI를 돌리지 말고, 먼저 8번에서 품질 Error=0 확인 후 3,000건 작업계획을 고정하세요.")
